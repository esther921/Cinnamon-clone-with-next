                    ...
                    <div className="pt-36 px-16 flex flex-col text-white ">
                        <div className=" grid grid-cols-3 flex-1 pb-24">
                            ...
                            <div className="col-span-2 space-y-10 pl-16 pt-6">
                                ...
                                <div className="grid grid-cols-3 space-x-24">
                                    <Header_paragraph heading={"Zagreb"}
                                        paragraph={"Slavonska avenija 6,10000, Zagreb, Croatia +385 99 347 3103"}/>
                                    <Header_paragraph heading={"New York"}
                                        paragraph={"500 7th Ave, New York, NY 10018, United States"}/>
                                    <Header_paragraph heading={"Belgrade"}
                        ...
                        <div className=" flex flex-col gap-8 divide-y divide-zinc-500">
                            <div className="grid grid-cols-3 gap-56">
                                <Link className="place-self-end underline underline-offset-1 pr-8"
                                    href={""}>hello@cinnamon.agency</Link>
                                <div className="flex flex-col gap-4 pr-12 pt-6 w-[18rem]">
                                    <p className="font-bold ">
                                        Our newsletter
                                    </p>
                                    <div class="flex items-center border-b border-zinc-400 py-2">
                                        <input className="text-lg bg-transparent text-zinc-400 outline-none underline underline-offset-8"
                                            type={'text'}
